    ...
    <form id="form1" runat="server">
            ...
            <asp:GridView ID="GridView1" runat="server" AllowSorting="True" AutoGenerateColumns="False" DataKeyNames="STUDENT_ID,COURSE_ID,LESSON_NUMBER" DataSourceID="SqlDataSource1">
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Student_Name">
                        <ItemTemplate>
                            <asp:DropDownList Enabled="false" ID="DropDownList4" runat="server" DataSourceID="Student" DataTextField="STUDENT_NAME" DataValueField="STUDENT_ID" SelectedValue='<%# Bind("STUDENT_ID") %>'>
                            </asp:DropDownList>
                    ...
                    <asp:TemplateField HeaderText="Course_Title">
                        <ItemTemplate>
                            <asp:DropDownList Enabled="false" ID="DropDownList5" runat="server" DataSourceID="Course" DataTextField="COURSE_TITLE" DataValueField="COURSE_ID" SelectedValue='<%# Bind("COURSE_ID") %>'>
                            </asp:DropDownList>
                    ...
                    <asp:TemplateField HeaderText="Lesson_Title">
                        <ItemTemplate>
                            <asp:DropDownList Enabled="false" ID="DropDownList6" runat="server" DataSourceID="lesson" DataTextField="LESSON_TITLE" DataValueField="LESSON_NUMBER" SelectedValue='<%# Bind("LESSON_NUMBER") %>'>
                            </asp:DropDownList>
                            <asp:SqlDataSource ID="lesson" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" ProviderName="<%$ ConnectionStrings:ConnectionString.ProviderName %>" SelectCommand="SELECT &quot;LESSON_NUMBER&quot;, &quot;LESSON_TITLE&quot; FROM &quot;LESSON&quot;"></asp:SqlDataSource>
                        </ItemTemplate>
                    </asp:TemplateField>
        ...
        <asp:FormView ID="FormView1" runat="server" DataKeyNames="STUDENT_ID,COURSE_ID,LESSON_NUMBER" DataSourceID="SqlDataSource1">
            <InsertItemTemplate>
                ...
                <br />
                LESSON_NUMBER:
                <asp:DropDownList ID="DropDownList3" runat="server" DataSourceID="lesson" DataTextField="LESSON_TITLE" DataValueField="LESSON_NUMBER" SelectedValue='<%# Bind("LESSON_NUMBER") %>'>
                </asp:DropDownList>
                <asp:SqlDataSource ID="lesson" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" ProviderName="<%$ ConnectionStrings:ConnectionString.ProviderName %>" SelectCommand="SELECT &quot;LESSON_NUMBER&quot;, &quot;LESSON_TITLE&quot; FROM &quot;LESSON&quot;"></asp:SqlDataSource>
                <br />
                LESSON_STATUS:
